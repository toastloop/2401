...
public class Lab1_Knowlton{
    public static void main(String[] args){
            ...
            try{
                ...
                inputFile = new File("Lab1_Inputfile2_Knowlton.txt");
            ...
            // Holds the student number, increases on each loop
            int studentNum =  0;
            ...
            while(inputScanner.hasNextLine()){
                ...
                while(lineScanner.hasNextInt()){
                    ...
                    if(grade < 0){
                        throw new Exception("Grade must not include a negative number");
                    }
